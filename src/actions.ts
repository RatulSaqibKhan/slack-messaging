import { FILE_NAME } from "./config/slack";
import { SlackApp } from "./libs/slack";
import * as fs from "fs";
import * as path from "path";

const sendSlackSimpleMessage = async (app: SlackApp) => {
...
const sendSlackBlockMessage = async (app: SlackApp) => {
...
const uploadFileInSlack = async (app: SlackApp) => {
  const filename = FILE_NAME;
  const initialComment = filename;
